...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            // Add caching headers for static assets to improve client-side caching
            \App\Http\Middleware\SetStaticCacheHeaders::class,
        ],
    ...
    protected $routeMiddleware = [
        ...
        // Spatie Permission
        // If the Spatie middleware classes are available use them, otherwise fall back to a local middleware that
        // checks the user's roles via the User model's role helpers (or a simple attribute).
